  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button onClick={() => createCompany.mutate({ name: 'New Company', slug: `company-${Date.now()}` })} disabled={createCompany.isPending}>
      ...
      <div className="grid gap-6">
        {companies.map((company: any) => (
          <div key={company.id} className="bg-card border rounded-lg p-6">
